...
exports.checkStringModeActive = exports.checkDebugModeActive = void 0;
const checkDebugModeActive = function () {
    if (typeof window === "undefined")
        return globalThis.isDebugModeActive;
    else
        return window.isDebugModeActive;
};
exports.checkDebugModeActive = checkDebugModeActive;
const checkStringModeActive = function () {
    if (typeof window === "undefined")
        return globalThis.isStringModeActive;
    else
        return window.isStringModeActive;
};
exports.checkStringModeActive = checkStringModeActive;
const l = function (t, ...args) {
